...
using Empress.Labs.PowerShell.Common;

namespace Empress.Labs.PowerShell.TestTools.UnitTesting.Cmdlets;
...
public sealed class SetLocationCmdlet() : PSCmdletProxy("Microsoft.PowerShell.Management\\Set-Location") {
  ...
  [ValidateNotNullOrEmpty]
  public string LiteralPath { get; init; } = null!;
